...
/**
 * This scope includes all allocations of the specified class.
 * 
 * @author Alexander Wert
 * 
 */
public class ObjectAllocationScope extends AbstractEnclosingScope {
	private Set<String> classNames;

	/**
	 * Default Constructor.
	 */
	public ObjectAllocationScope() {
	}
	...
	public boolean equals(Object obj) {
		...
		ObjectAllocationScope other = (ObjectAllocationScope) obj;
		if (classNames == null) {
	...
	public class EntityBuilder extends AbstractEntityBuilder {
		...
		protected EntityBuilder(InstrumentationDescriptionBuilder parentBuilder) {
			...
			eiEntity.setScope(ObjectAllocationScope.this);
		}
		 ...
		 * 
		 * @param className
		 *            name of the class whose object allocations to instrument
		 * @return an entity builder
		 */
		public synchronized EntityBuilder addClass(String className) {
			ObjectAllocationScope.this.getClassNames().add(className);
			return this;
		}
